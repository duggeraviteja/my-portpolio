  ...
  experience: [
    {
      ...
      state: 'current',
      desc: 'Owning VCS architecture, remote studio backend systems, and platform modernization for the WaveMaker low-code platform.',
      bullets: [
        'Designed Migration vs User Changes Separation — built REST APIs (Spring Boot, Maven, Hibernate) for project creation & Git integration workflows, resolving customer-reported issues and eliminating accidental rollback',
      ...
      stack: ['Java 17', 'Spring Boot', 'JGit', 'Git', 'Maven', 'NGINX', 'Docker', 'REST APIs'],
    },
    {
